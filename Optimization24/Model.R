...
h_test <- 22
x_test <- c()
x_test <- c(x_test, rep(0,h_test-1), optim$solution[h_test+24*0]-30,  rep(0,times=24-h_test)) #TZ1
...
x_test <- c(x_test, rep(0,h_test-1), optim$solution[h_test+24*3]-30,  rep(0,times=24-h_test))
...
x_test <- c(x_test, rep(0,h_test-1), optim$solution[h_test+24*7]+30,  rep(0,times=24-h_test))
x_test <- c(x_test, rep(0,h_test-1), optim$solution[h_test+24*8]-30,  rep(0,times=24-h_test))
